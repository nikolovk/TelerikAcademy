...
namespace _01Events
{
    public class Program
    {
        ...
        private static void GetParameters(string commandForExecution, string commandType, out DateTime dateAndTime, out string eventTitle, out string eventLocation)
        {
            ...
            {
                int commandStart = firstPipeIndex + 1;
                int commandLength = lastPipeIndex - firstPipeIndex - 1;
                eventTitle = commandForExecution.Substring(commandStart, commandLength).Trim();
